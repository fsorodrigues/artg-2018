...
function Matrix(_) {
    ...
    function exports(data, game_logs) {
        ...
        // setting up accessor, calling draw function
        drawRects.accessor(_accessor)
        drawRects(data,game_logs);
        ...
        // constructing <div> for buttons, calling function to append buttons
...
function DrawRects(_) {
    ...
    // Update
    // remove all to avoid object constancy confusion. persisting is weird
    ...
    const binsEnter = binsUpdate.enter()
        ...
        .on('mouseenter', function(d) {_dispatch.call('rect:enter', this, d, d3.select(this).attr('value'),game_logs);})
